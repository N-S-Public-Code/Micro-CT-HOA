...
def stitch_images(image1, image2):
    ...
    """
    keypoints1, descriptors1 = brief.detectAndCompute((image1/256).astype('uint8'), None)
    keypoints2, descriptors2 = brief.detectAndCompute((image1/256).astype('uint8'), None)
    """

    keypoints1 = fast.detect((image1/256).astype('uint8'), None)
    _ , descriptors1 = brief.compute((image1/256).astype('uint8'), keypoints1)
    keypoints2 = fast.detect((image2/256).astype('uint8'), None)
    _ , descriptors2 = brief.compute((image2/256).astype('uint8'), keypoints2)
